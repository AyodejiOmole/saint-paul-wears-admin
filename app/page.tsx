...
export default function DashboardPage() {
  ...
  const { data, isLoading, isError } = useQuery<AdminSummary>({
        ...
        <main className="p-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="border-border">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-secondary">₦{ data?.revenue ? Number(data?.revenue)?.toLocaleString() : 0 }</div>
            ...
            <Card className="border-border">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-accent">{ data?.orders ?? 0 }</div>
            ...
            <Card className="border-border">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-primary">{ data?.users ?? 0 }</div>
